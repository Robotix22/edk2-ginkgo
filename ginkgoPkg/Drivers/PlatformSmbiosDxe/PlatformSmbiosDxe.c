...
CHAR8 mBiosVersion[128] = "edk2-ginkgo";
...
CHAR8 mCpuName[128] = "Qualcomm Snapdragon 665";

CHAR8 *mProcessorInfoType4Strings[] = {
    "BGA-1156", "Qualcomm", "Snapdragon 665", NULL};
...
CHAR8 *mOemStringsType11Strings[] = {
    "https://github.com/Robotix22/edk2-ginkgo", NULL};
    ...
    IN EFI_HANDLE ImageHandle, IN EFI_SYSTEM_TABLE *SystemTable)
{
  ...
  AsciiSPrint(
      mBiosVersion, sizeof(mBiosVersion), "edk2-ginkgo %s",
